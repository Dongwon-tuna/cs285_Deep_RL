...
# Determine exploration rate
        ...
        # Select an action without computing gradients
        with torch.no_grad():
        ...
        # Check if the episode was terminated due to a time limit (truncation)
        truncated = info.get("TimeLimit.truncated", False)
        
        # Store the experience in the replay buffer
        # The terminal flag for the buffer should only be True if the episode ended naturally, not by truncation.
        ...
        # Add the observation to a list for visualization
        ...
        if done or truncated:
            ...
            # Otherwise, the next observation becomes the current one
